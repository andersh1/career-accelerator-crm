...
const EMAILS: PlaybookEmail[] = [
  ...
  },
  {
    ...
    trigger: "Cohorts → Schedule → preamble date for Module 1. Sends once; a switched-off template waits rather than being skipped.",
    source: "CRM", guard: "Active cohorts only", templateKey: "module-preamble-1",
    sampleVars: { firstName: "Jordan", moduleNumber: "1", moduleTitle: "Self", preworkDue: "Sunday, September 6", sessionDate: "Tuesday, September 8" },
  },
  {
    id: "module-preamble-2", name: "Module 2 Kick-off — Market Discovery",
    subject: "Module 2: Market Discovery — here is the week ahead",
    audience: "Every Fellow in the cohort", when: "9:00 AM ET on the preamble date set per cohort",
    trigger: "Cohorts → Schedule → preamble date for Module 2. Sends once; a switched-off template waits rather than being skipped.",
    source: "CRM", guard: "Active cohorts only", templateKey: "module-preamble-2",
    sampleVars: { firstName: "Jordan", moduleNumber: "2", moduleTitle: "Market Discovery", preworkDue: "Sunday, September 6", sessionDate: "Tuesday, September 8" },
  },
  {
    id: "module-preamble-3", name: "Module 3 Kick-off — Wedge",
    subject: "Module 3: Wedge — here is the week ahead",
    audience: "Every Fellow in the cohort", when: "9:00 AM ET on the preamble date set per cohort",
    trigger: "Cohorts → Schedule → preamble date for Module 3. Sends once; a switched-off template waits rather than being skipped.",
    source: "CRM", guard: "Active cohorts only", templateKey: "module-preamble-3",
    sampleVars: { firstName: "Jordan", moduleNumber: "3", moduleTitle: "Wedge", preworkDue: "Sunday, September 6", sessionDate: "Tuesday, September 8" },
  },
  {
    id: "module-preamble-4", name: "Module 4 Kick-off — Experiment",
    subject: "Module 4: Experiment — here is the week ahead",
    audience: "Every Fellow in the cohort", when: "9:00 AM ET on the preamble date set per cohort",
    trigger: "Cohorts → Schedule → preamble date for Module 4. Sends once; a switched-off template waits rather than being skipped.",
    source: "CRM", guard: "Active cohorts only", templateKey: "module-preamble-4",
    sampleVars: { firstName: "Jordan", moduleNumber: "4", moduleTitle: "Experiment", preworkDue: "Sunday, September 6", sessionDate: "Tuesday, September 8" },
  },
  {
    id: "module-preamble-5", name: "Module 5 Kick-off — Story",
    subject: "Module 5: Story — here is the week ahead",
    audience: "Every Fellow in the cohort", when: "9:00 AM ET on the preamble date set per cohort",
    trigger: "Cohorts → Schedule → preamble date for Module 5. Sends once; a switched-off template waits rather than being skipped.",
    source: "CRM", guard: "Active cohorts only", templateKey: "module-preamble-5",
    sampleVars: { firstName: "Jordan", moduleNumber: "5", moduleTitle: "Story", preworkDue: "Sunday, September 6", sessionDate: "Tuesday, September 8" },
  },
  {
    id: "module-preamble-6", name: "Module 6 Kick-off — Network + Pipeline",
    subject: "Module 6: Network + Pipeline — here is the week ahead",
    audience: "Every Fellow in the cohort", when: "9:00 AM ET on the preamble date set per cohort",
    trigger: "Cohorts → Schedule → preamble date for Module 6. Sends once; a switched-off template waits rather than being skipped.",
    source: "CRM", guard: "Active cohorts only", templateKey: "module-preamble-6",
    sampleVars: { firstName: "Jordan", moduleNumber: "6", moduleTitle: "Network + Pipeline", preworkDue: "Sunday, September 6", sessionDate: "Tuesday, September 8" },
  },
  {
    id: "module-preamble-7", name: "Module 7 Kick-off — Money + Lifestyle",
    subject: "Module 7: Money + Lifestyle — here is the week ahead",
    audience: "Every Fellow in the cohort", when: "9:00 AM ET on the preamble date set per cohort",
    trigger: "Cohorts → Schedule → preamble date for Module 7. Sends once; a switched-off template waits rather than being skipped.",
    source: "CRM", guard: "Active cohorts only", templateKey: "module-preamble-7",
    sampleVars: { firstName: "Jordan", moduleNumber: "7", moduleTitle: "Money + Lifestyle", preworkDue: "Sunday, September 6", sessionDate: "Tuesday, September 8" },
  },
  {
    id: "module-preamble-8", name: "Module 8 Kick-off — Personal Board",
    subject: "Module 8: Personal Board — here is the week ahead",
    audience: "Every Fellow in the cohort", when: "9:00 AM ET on the preamble date set per cohort",
    trigger: "Cohorts → Schedule → preamble date for Module 8. Sends once; a switched-off template waits rather than being skipped.",
    source: "CRM", guard: "Active cohorts only", templateKey: "module-preamble-8",
    sampleVars: { firstName: "Jordan", moduleNumber: "8", moduleTitle: "Personal Board", preworkDue: "Sunday, September 6", sessionDate: "Tuesday, September 8" },
  },
];
