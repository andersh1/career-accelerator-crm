...
const sections: Section[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Closing a task out", desc: "Write what you actually did in the \"What we did\" box, then press Save & close out. It marks the task Done and emails everyone on Keep informed with the solution, so you don't have to go and tell them. The note stays on the card, which is what you want weeks later when the same question comes back. Closing without a note is still possible by dragging the card — nobody is emailed in that case." },
