...
const sections: Section[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Automatic owner", desc: "New leads arrive with an owner already set: consultation bookings go to Dan, program-info and waitlist enquiries go to David. The lead's timeline records the routing, and the whole team still gets the alert email either way. Applications stay unassigned on purpose — pick an owner from the Owner dropdown on the lead. Setting an owner by hand always overrides the routing." },
