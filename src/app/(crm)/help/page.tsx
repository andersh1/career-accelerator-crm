...
const sections: Section[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Automatic owner", desc: "New leads arrive with an owner already set: applications and consultation bookings go to Dan, program-info and waitlist enquiries go to David. The lead's timeline records the routing, and Dan, Caleb and David all get the alert email whoever owns it. Setting an owner by hand from the Owner dropdown always overrides the routing." },
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Closing a task out", desc: "Write what you actually did in the \"What we did\" box, then press Save & close out. It marks the task Done and drops a notification in the CRM for everyone on Keep informed, with the solution in it, so nobody has to be told by hand. No email — this is a tool you are in every day. The note stays on the card, which is what you want weeks later when the same question comes back. Closing without a note is still possible by dragging the card — nobody is notified in that case." },
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Admitting a Fellow hands off to Ignition", desc: "Moving a lead to Admitted fires the lead.admitted webhook — point a Zap at it to create their Ignition client, mapping leadId into the client's external reference. It also raises a task, \"Send the Ignition proposal\", on the lead owner. The handoff stops there deliberately: sending a tuition agreement and a request for payment details is not something a drag on the pipeline board should do by itself." },
